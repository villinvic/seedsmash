...
class SS0(BaseModel):
    ...
    def __init__(
        ...
        self.player_embeddings = snt.nets.MLP([64,64], activate_final=True)
        ...
        # undelay LSTM
        self.undelay_lstm = snt.DeepRNN([ResGRUBlock(64) for _ in range(1)])
    ...
    def forward(self,
        ...
        if single_obs:
            ...
            last_action = tf.expand_dims(last_action, axis=0)
        ...
        obs_input_post_embedding = self.post_embedding_concat(
            [self_embedded, last_action, undelayed_opp_embedded]
        )
